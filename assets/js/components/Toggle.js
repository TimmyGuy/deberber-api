...
export default function Toggle({ checked = false, onToggle, item }) {
    ...
    return (
        <Switch
            ...
            className={classNames(
                enabled ? 'bg-green-600 focus:ring-green-500' : 'bg-red-200 focus:ring-red-200',
        ...
        >
            <span className="sr-only">Gebruik instelling</span>
            <span
                className={classNames(

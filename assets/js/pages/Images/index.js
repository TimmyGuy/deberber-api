            ...
            <div className="flex-1 flex items-stretch overflow-hidden">
                <main className="flex-1 overflow-y-auto">
                    <div className="pt-8 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="flex">
                            <h1 className="flex-1 text-2xl font-bold text-gray-900">Afbeeldingen</h1>
                        </div>
                            ...
                            <button
                                ...
                                onClick={() => {
                                    if(confirm("Weet je zeker dat je deze afbeelding wilt verwijderen?")) {
                                        fetch('/api/images/' + currentFile.id, {
                                            method: "DELETE",
                                        }).then(r => {
                                            if(r.status === 404) {
...
function SkeletonLoader() {
    return (
        <div className="border shadow rounded-md p-4 max-w-sm w-full mx-auto">
            <div className="animate-pulse flex flex-column space-x-4">
